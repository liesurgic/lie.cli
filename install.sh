...
# lie CLI Framework Installer
# Installs the framework to $HOME/.lie
...
echo -e "${BLUE}Installing lie CLI Framework...${NC}"
...
cp -r "$SCRIPT_DIR/framework"/* "$LIE_HOME/"
...
echo -e "${GREEN}✅ lie CLI Framework installed successfully!${NC}"
echo -e "${BLUE}Framework location: $LIE_HOME${NC}"
